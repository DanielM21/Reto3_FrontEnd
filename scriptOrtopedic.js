...
function traerInformacionOrtopedic(){
    $.ajax({
        datatype:"JSON",
        url:"http://129.151.100.166:8080/api/Ortopedic/all",
        type:"GET",
...
function guardarInformacionOrtopedic(){
    let infoOrtopedic = {
        ...
        url:"http://129.151.100.166:8080/api/Ortopedic/save",
...
function obtenerItemEspecifico(idElemento){
    ...
    $.ajax({
        dataType: 'json',
        url:"http://129.151.100.166:8080/api/Ortopedic/"+idElemento,
        type: 'GET',
...
function actualizarInformacionOrtopedic(idElemento){
    ...
    $.ajax({
        url:"http://129.151.100.166:8080/api/Ortopedic/update",
        type:"PUT",
        data:dataToSend,
